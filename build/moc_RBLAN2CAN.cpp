...
QT_MOC_LITERAL(3, 19, 16), // "onSock1Connected"
QT_MOC_LITERAL(4, 36, 19), // "onSock1Disconnected"
QT_MOC_LITERAL(5, 56, 16) // "onSock1ReadyRead"

    },
    "RBLAN2CAN\0onTimer\0\0onSock1Connected\0"
    "onSock1Disconnected\0onSock1ReadyRead"
};
...
void RBLAN2CAN::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onSock1Connected(); break;
        case 2: _t->onSock1Disconnected(); break;
        case 3: _t->onSock1ReadyRead(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
